...
void coreTask( void * pvParameters ){
    ...
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC003&device_id=D2-HAD45M3NB45DF&switche_status=1");
    ...
    Serial.println("LOW0");
    digitalWrite(4, LOW);
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC003&device_id=D2-HAD45M3NB45DF&switche_status=2");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  }}
  if(digitalRead(25) == HIGH) {
    ...
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC002&device_id=D2-HAD45M3NB45DF&switche_status=1");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  } 
    ...
    Serial.println("LOW1");
    digitalWrite(2, LOW);
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC002&device_id=D2-HAD45M3NB45DF&switche_status=2");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  }}
   if(digitalRead(23) == HIGH) {
    ...
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC003&device_id=DVC114&switche_status=1");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  } 
    ...
    Serial.println("LOW2");
    digitalWrite(21, LOW);
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC003&device_id=DVC114&switche_status=2");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  }}
   if(digitalRead(18) == HIGH) {
    ...
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC004&device_id=DVC114&switche_status=1");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
    ...
    Serial.println("LOW3");
    digitalWrite(22, LOW);
    http.begin("http://15.207.217.5:8050/api/switche-on-off-by-device?switch_id=SWC004&device_id=DVC114&switche_status=2");
    http.addHeader("authorization","Kd/C0gqljjf6zmhBRb5SkL5mDZhXYfkr1EVxTbKwCxE=");
    http.GET();
    delay(1000);
  }}
...
void setup() {
 ...
 pinMode(26, INPUT);
  ...
  SerialBT.begin("D4-"+String(WiFi.macAddress())+"_SEHOME"); //Bluetooth device name
   EEP();
   const char* Ssid;
   const char* password;
   Serial.print(ssid);
